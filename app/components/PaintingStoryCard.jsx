  ...
  return (
    ...
    >
      ...
      <div className="bg-black p-5">
        ...
        <button className="border border-offWhite-500 py-2 px-3 text-sm hover:transition-all rounded-md hover:border-black transition-all hover hover:bg-secondary-500 hover:text-offBlack-500">
          View all Images
        </button>
      </div>
    </div>
