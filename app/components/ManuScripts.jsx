          ...
          <div className="w-full flex items-center justify-between sm:hidden">
            <div className="flex items-center space-x-4">
              <div
                ...
                className="text-offBlack-400 font-medium pl-1 text-xs xl:text-sm col-span-1 sm:text-center"
              >
                Results: {`(${totalPage ? totalPage : 0} records)`}
              </div>
              <button
            ...
            <button
              className={`bg-primary-500 text-white block sm:hidden max-w-fit w-auto px-2 py-2 ${
